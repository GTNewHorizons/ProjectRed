...
object TransportationRecipes {
  ...
  private def initNetPipeRecipes() {
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PipeDefs.ROUTEDJUNCTION.makeStack(16),
        "RrG",
        "dgd",
        "GrR",
        'R': JC,
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PipeDefs.ROUTEDINTERFACE.makeStack,
        "rgr",
        "gjg",
        "rgr",
        'g': JC,
        "nuggetGold",
        'j': JC,
        PipeDefs.ROUTEDJUNCTION.makeStack,
        'r': JC,
        "dustRedstone"
      )
    )
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PipeDefs.ROUTEDREQUEST.makeStack,
        "rdr",
        "rjr",
        "rdr",
        'r': JC,
    ...
    GameRegistry.addRecipe(
      PipeDefs.ROUTEDFIREWALL.makeStack,
      "bcb",
      "cjc",
      "bcb",
      'b': JC,
    ...
    /** Network Valve pipe * */
    GameRegistry.addRecipe(
      PipeDefs.NETWORKVALVE.makeStack,
      " g ",
      "gbg",
      " l ",
      'g': JC,
    ...
    GameRegistry.addRecipe(
      PipeDefs.NETWORKLATENCY.makeStack,
      " c ",
      "cbc",
      " c ",
      'c': JC,
  ...
  private def initPressureTubeRecipes() {
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PipeDefs.PRESSURETUBE.makeStack(8),
        "gpg",
        "p p",
        "gpg",
        'g': JC,
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PipeDefs.RESISTANCETUBE.makeStack,
        "i",
        "t",
        'i': JC,
        "ingotIron",
        't': JC,
        PipeDefs.PRESSURETUBE.makeStack
      )
    )
  }
  ...
  private def initChipRecipes() {
    RecipeSorter.register(
      "projectred:chipreset",
      classOf[ChipResetRecipe],
      SHAPED,
      "after:forge:shaped"
    )
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        PartDefs.NULLROUTINGCHIP.makeStack,
        "gpp",
        "grr",
        "g  ",
        'g': JC,
    ...
    /** Item Responder * */
    addChipRecipe(
      RoutingChipDefs.ITEMRESPONDER.makeStack,
      "ingotIron",
      "dustRedstone",
      "dustRedstone",
    ...
    addChipRecipe(
      RoutingChipDefs.DYNAMICITEMRESPONDER.makeStack,
      "ingotIron",
      "dustRedstone",
    ...
    addChipRecipe(
      RoutingChipDefs.ITEMOVERFLOWRESPONDER.makeStack,
      "ingotIron",
      "dustRedstone",
      "dustRedstone",
      PartDefs.GREENILLUMAR.makeStack,
    ...
    /** Item Terminator * */
    addChipRecipe(
      RoutingChipDefs.ITEMTERMINATOR.makeStack,
      "ingotIron",
      "dustRedstone",
      "dustRedstone",
    ...
    /** Item Extractor * */
    addChipRecipe(
      RoutingChipDefs.ITEMEXTRACTOR.makeStack,
      "ingotIron",
      "dustRedstone",
      "dustRedstone",
      PartDefs.CYANILLUMAR.makeStack,
    ...
    /** Item Broadcaster * */
    addChipRecipe(
      RoutingChipDefs.ITEMBROADCASTER.makeStack,
      "ingotGold",
      "dustRedstone",
      "dustRedstone",
    ...
    /** Item Stock Keeper * */
    addChipRecipe(
      RoutingChipDefs.ITEMSTOCKKEEPER.makeStack,
      "gemDiamond",
      "dustRedstone",
      "dustRedstone",
    ...
    /** Item Crafting * */
    addChipRecipe(
      RoutingChipDefs.ITEMCRAFTING.makeStack,
      "dustGlowstone",
      "dustRedstone",
      "dustGlowstone",
    ...
    addChipRecipe(
      RoutingChipDefs.ITEMEXTENSION.makeStack,
      "dustGlowstone",
      "dustRedstone",
      "dustRedstone",
      PartDefs.REDILLUMAR.makeStack,
  ...
  private def initUpgradeRecipes() {
    ...
    GameRegistry.addRecipe(
      new ShapedOreRecipe(
        new ItemStack(ProjectRedTransportation.itemRouterUtility),
        "  r",
        "iei",
        "iii",
        'r': JC,
...
class ChipResetRecipe extends IRecipe {
  def matches(inv: InventoryCrafting, world: World) =
    getCraftingResult(inv) != null

  def getCraftingResult(inv: InventoryCrafting): ItemStack = {
    val cdef = getType(inv)
    if (cdef != null)
      if (isTypeExclusive(cdef, inv)) return cdef.makeStack(countUnits(inv))
    null
  }
