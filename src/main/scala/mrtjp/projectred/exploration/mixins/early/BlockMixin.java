...
public class BlockMixin {
    ...
    @WrapOperation(method = "registerBlocks", at = @At(value = "NEW", target = "(Lnet/minecraft/block/material/Material;)Lnet/minecraft/block/Block;", ordinal = 3), remap = false, require = 1)
