...
object Configurator extends ModConfig("ProjRed|Core") {
  ...
  override protected def initValues() {
    ...
    gen_Sapphire_resistance =
      gen.put("Sapphire Ore resistance", gen_Sapphire_resistance)
    gen_Sapphire_retro = gen.put("Sapphire Ore retrogen", gen_Sapphire_retro)

    gen_Peridot = gen.put("Peridot Ore", gen_Peridot)
    gen_Peridot_resistance =
      gen.put("Peridot Ore resistance", gen_Peridot_resistance)
    gen_Peridot_retro = gen.put("Peridot Ore retrogen", gen_Peridot_retro)

    gen_MarbleCave = gen.put("Marble Caves", gen_MarbleCave)
    gen_MarbleCave_resistance =
      gen.put("Marble Caves resistance", gen_MarbleCave_resistance)
    gen_MarbleCave_retro =
      gen.put("Marble Caves retrogen", gen_MarbleCave_retro)

    gen_Volcano = gen.put("Volcanos", gen_Volcano)
    gen_Volcano_resistance =
      gen.put("Volcano resistance", gen_Volcano_resistance)
    gen_Volcano_retro = gen.put("Volcano retrogen", gen_Volcano_retro)

    gen_Lily = gen.put("Deviating Lily", gen_Lily)
    gen_Lily_resistance =
      gen.put("Deviating Lily resistance", gen_Lily_resistance)
    gen_Lily_retro = gen.put("Deviating Lily retrogen", gen_Lily_retro)

    gen_Copper = gen.put("Copper Ore", gen_Copper)
    gen_Copper_resistance =
      gen.put("Copper Ore resistance", gen_Copper_resistance)
    ...
    gen_Silver_resistance =
      gen.put("Silver Ore resistance", gen_Silver_resistance)
    gen_Silver_retro = gen.put("Silver Ore retrogen", gen_Silver_retro)

    gen_Electrotine = gen.put("Electrotine Ore", gen_Electrotine)
    gen_Electrotine_resistance =
      gen.put("Electrotine Ore resistance", gen_Electrotine_resistance)
    gen_Electrotine_retro =
      gen.put("Electrotine Ore retrogen", gen_Electrotine_retro)
...
class ProjectRedConfigGui(parent: GuiScreen)
    extends SpecialConfigGui(parent, "ProjRed|Core", Configurator.config)
