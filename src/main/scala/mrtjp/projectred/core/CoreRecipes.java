...
public class CoreRecipes {
    ...
    private static void initToolRecipes() {
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(ProjectRedCore.itemScrewdriver()),
                        "i  ",
                        " ib",
                        " bi",
                        'i',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(ProjectRedCore.itemWireDebugger()),
                        "a a",
                        "ber",
                        "bgr",
                        'a',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        new ItemStack(ProjectRedCore.itemDataCard()),
                        "pp ",
                        "prp",
                        "prp",
                        'p',
    ...
    private static void initPartRecipes() {
        ...
        /** Cathode **/
        GameRegistry.addRecipe(CATHODE().makeStack(), "t", "p", 't', Blocks.redstone_torch, 'p', PLATE().makeStack());
        ...
        GameRegistry.addRecipe(
                ENERGIZEDSILICONCHIP().makeStack(),
                " e ",
                "ppp",
                'e',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        PLATFORMEDPLATE().makeStack(),
                        " r ",
                        "sps",
                        "prp",
                        'r',
                        WIREDPLATE().makeStack(),
                        's',
                        "stickWood",
                        'p',
                        PLATE().makeStack()));
        ...
        GameRegistry.addRecipe(
                ...
                "b",
                's',
                new ItemStack(MicroblockProxy.sawDiamond(), 1, OreDictionary.WILDCARD_VALUE),
                'b',
                SILICONBOULE().makeStack());
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ...
                        "ingotCopper",
                        'd',
                        new ItemStack(ProjectRedCore.itemDrawPlate(), 1, OreDictionary.WILDCARD_VALUE)));
        ...
        /** Sail **/
        GameRegistry.addRecipe(SAIL().makeStack(), "ss", "ss", "ss", 's', WOVENCLOTH().makeStack());

        /** Red Iron Compound **/
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        REDIRONCOMPOUND().makeStack(),
                        "rrr",
                        "rir",
                        "rrr",
                        'r',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        GLOWINGSILICONCOMPOUND().makeStack(),
                        "ggg",
                        "gsg",
                        "ggg",
                        'g',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ELECTROTINEIRONCOMPOUND().makeStack(),
                        "bbb",
                        "bib",
                        "bbb",
                        'b',
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(
                        ELECTROTINESILICONCOMPOUND().makeStack(),
                        "bbb",
                        "bsb",
                        "bbb",
                        'b',
